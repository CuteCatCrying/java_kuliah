...
public class StudentRecordExample {
     public static void main(String[] args) {
        ...
        StudentRecordNew jarwo = new StudentRecordNew();
        ...
        jarwo.setName("Jarwo");
        jarwo.setAddress("Jateng");
        jarwo.setAge(21);
        jarwo.setMathGrade(76);
        jarwo.setEnglishGrade(40);
        jarwo.setScienceGrade(80);
        jarwo.setCompGrade(90);
        
        System.out.println("Nama\t\t: "+jarwo.getName());
        System.out.println("Alamat\t\t: "+jarwo.getAddress());
        System.out.println("Umur\t\t: "+jarwo.getAge());
        System.out.println("Rata-rata\t: "+jarwo.getAverage());
        System.out.println();
